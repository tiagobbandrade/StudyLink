    ...
    <div
      ...
      className={`w-full flex items-start justify-start flex-col ${
        error
          ...
          : "[&>input]:text-zinc-500 [&>input]:border-zinc-900 [&>input]:shadow-zinc-400 [&>input]:placeholder:text-zinc-500 [&>input]:focus-within:bg-zinc-200 [&>input]:focus-within:bg-opacity-50 [&>label]:text-zinc-800 [&>label]:shadow-zinc-300"
      }`}
    >
      {children}
    </div>
